...
class SearchService:
    ...
    async def _count_matches_sql(self, query: str | None, tags: list[str] | None, *, fulltext: bool) -> int:
        if self.db is None:
            return 0
    ...
    async def _count_matches_supabase(self, query: str | None, tags: list[str] | None, *, fulltext: bool) -> int:
        db_query: Any = (
    ...
    async def _count_matches(self, query: str | None, tags: list[str] | None, *, fulltext: bool) -> int:
        ...
        if self.db:
            return await self._count_matches_sql(query, tags, fulltext=fulltext)
        return await self._count_matches_supabase(query, tags, fulltext=fulltext)
