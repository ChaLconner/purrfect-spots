...
class GalleryService:
    ...
    def get_all_photos(
        ...
        try:
            ...
            raise Exception(f"Failed to fetch gallery images: {str(e)}")
        ...
        try:
            ...
            if use_fulltext and self._fulltext_available:
                ...
                try:
                    ...
                    raise Exception(f"Failed to search photos: {str(e2)}")
            raise Exception(f"Failed to search photos: {str(e)}")
    ...
    def _get_popular_tags_impl(supabase_admin, limit: int) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Failed to get popular tags: {str(e)}")
    ...
    def get_user_photos(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Failed to fetch user images: {str(e)}")
    ...
    def get_nearby_photos(
        ...
        Uses bounding box approximation for efficient querying.
        For more accurate results, PostGIS extension would be recommended.
        ...
        Returns:
            List of nearby photos sorted by distance (approximate)
        """
        try:
            ...
            raise Exception(f"Failed to fetch nearby photos: {str(e)}")
