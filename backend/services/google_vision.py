...
class GoogleVisionService:
        ...
        try:
            ...
            if service_account_json:
                try:
                    ...
                    logger.error(f"Failed to initialize from environment variable: {str(env_error)}")
    ...
    def detect_cats(self, image_file: UploadFile) -> Dict:
        ...
        try:
            ...
            logger.debug(f"High confidence - labels: {has_high_confidence_labels}, objects: {has_high_confidence_objects}")
            ...
            logger.error(f"Google Vision detection failed: {type(e).__name__}: {str(e)}")
