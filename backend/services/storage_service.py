...
class StorageService:
    ...
    async def upload_file(self, file_content: bytes, content_type: str, file_extension: str = "jpg", folder: str = "upload") -> str:
        """
        ...
        try:
            ...
            # Note: For production, consider using CloudFront with signed URLs
