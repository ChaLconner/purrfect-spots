...
async def google_login_redirect():
    ...
    try:
        ...
        # Use the first origin as the redirect URI base
        origin = cors_origins[0].strip()
        redirect_uri = f"{origin}/auth/callback"
        
        # OAuth parameters with PKCE (these will be generated by the frontend)
        oauth_params = {
...
async def google_exchange_code(
    ...
    try:
        ...
        for origin in allowed_origins:
            if request.redirect_uri.startswith(origin):
