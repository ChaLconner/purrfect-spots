...
_ip_location_cache_state = {"expires_at": 0.0, "rate_limit_backoff_until": 0.0}
...
async def get_ip_location() -> dict[str, Any]:
    ...
    now = monotonic()
    if now < _ip_location_cache_state["expires_at"]:
    ...
    try:
        ...
        _ip_location_cache_state["expires_at"] = now + IP_GEOLOCATION_SUCCESS_TTL_SECONDS
