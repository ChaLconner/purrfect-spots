...
from utils.file_utils import validate_image_file, get_safe_file_extension
from utils.image_utils import optimize_image, is_valid_image
    ...
    try:
        ...
        log_security_event(
            ...
            details={
                ...
                "final_size_kb": len(contents) / 1024
            }
        )
...
def validate_location_data(location_name: str, description: Optional[str] = None) -> Tuple[str, str]:
    """
