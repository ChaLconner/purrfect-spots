...
if supabase_service_key:
    ...
    print(f"Debug: SUPABASE_SERVICE_ROLE_KEY found: {bool(supabase_service_key)}")
else:
    print("Warning: SUPABASE_SERVICE_ROLE_KEY not found - admin operations will use regular client")
