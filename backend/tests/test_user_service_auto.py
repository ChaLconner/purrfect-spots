...
def mock_supabase():
    ...
    mock_admin.auth.admin.create_user = AsyncMock(return_value=MagicMock(user=MagicMock(id="1", email="a@a.com", created_at="2023")))
    
    mock.auth.sign_in_with_password = AsyncMock(return_value=MagicMock(
