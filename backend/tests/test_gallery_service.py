...
class TestGalleryService:
    ...
    def test_get_all_photos_with_data(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_get_all_photos_pagination(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_get_all_photos_simple(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_search_photos_by_query(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_search_photos_by_tags(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_search_photos_combined(self, gallery_service, mock_supabase_admin, mock_cat_photo):
    ...
    def test_get_user_photos(self, gallery_service, mock_supabase_admin, mock_cat_photo):
