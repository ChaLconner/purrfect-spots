...
def test_get_all_gallery(client):
    mock_service = MagicMock()
    mock_service.get_all_photos_simple = AsyncMock(return_value=[{"id": "1", "image_url": "url", "latitude": 10, "longitude": 10, "location_name": "loc", "uploaded_at": "2024-03-20T10:00:00Z"}])
    app.dependency_overrides[get_gallery_service] = lambda: mock_service
...
def test_get_locations(client):
    mock_service = MagicMock()
    mock_service.get_map_locations = AsyncMock(return_value=[{"id": "1", "image_url": "url", "latitude": 10, "longitude": 10, "location_name": "loc", "uploaded_at": "2024-03-20T10:00:00Z"}])
    app.dependency_overrides[get_gallery_service] = lambda: mock_service
...
def test_get_viewport(client):
    mock_service = MagicMock()
    mock_service.get_nearby_photos = AsyncMock(return_value=[{"id": "1", "image_url": "url", "latitude": 10, "longitude": 10, "location_name": "loc", "uploaded_at": "2024-03-20T10:00:00Z"}])
    app.dependency_overrides[get_gallery_service] = lambda: mock_service
...
def test_search_locations(client):
    mock_service = MagicMock()
    mock_service.search_photos = AsyncMock(return_value=[{"id": "1", "image_url": "url", "latitude": 10, "longitude": 10, "location_name": "loc", "uploaded_at": "2024-03-20T10:00:00Z"}])
    app.dependency_overrides[get_gallery_service] = lambda: mock_service
...
def test_get_photo(client):
    mock_service = MagicMock()
    mock_service.get_photo_by_id = AsyncMock(return_value={"id": "1", "image_url": "url", "latitude": 10, "longitude": 10, "location_name": "loc", "uploaded_at": "2024-03-20T10:00:00Z"})
    app.dependency_overrides[get_gallery_service] = lambda: mock_service
