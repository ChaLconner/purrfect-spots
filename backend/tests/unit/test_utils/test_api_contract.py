...
class TestCompareSchemas:
    ...
    def test_endpoint_removed(self) -> None:
        ...
        baseline: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {}}, "/api/v1/cats": {"get": {}}}}
        current: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {}}}}
    ...
    def test_method_removed(self) -> None:
        ...
        baseline: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {}, "post": {}}}}
        current: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {}}}}
    ...
    def test_required_param_removed(self) -> None:
        ...
        current: dict[str, Any] = {
            "paths": {"/api/v1/users": {"get": {"parameters": [{"name": "limit", "required": False}]}}}
        }
    ...
    def test_optional_param_removed_no_breaking_change(self) -> None:
        """Test that removing optional parameter is NOT a breaking change."""
        baseline: dict[str, Any] = {
            "paths": {"/api/v1/users": {"get": {"parameters": [{"name": "limit", "required": False}]}}}
        }
        current: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {"parameters": []}}}}

        changes = compare_schemas(baseline, current)
        assert len(changes) == 0

    def test_response_removed(self) -> None:
        """Test detection of removed response code."""
        baseline: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {"responses": {"200": {}, "404": {}}}}}}
        current: dict[str, Any] = {"paths": {"/api/v1/users": {"get": {"responses": {"404": {}}}}}}
...
class TestNonBreakingChanges:
    ...
    def test_new_endpoint_detected(self) -> None:
        """Test that new endpoints are reported as warnings."""
        baseline: dict[str, Any] = {"info": {"version": "1.0.0"}, "paths": {"/api/v1/users": {"get": {}}}}
        current: dict[str, Any] = {
            "info": {"version": "1.0.0"},
            "paths": {"/api/v1/users": {"get": {}}, "/api/v1/cats": {"get": {}}},
        }
    ...
    def test_version_change_detected(self) -> None:
        ...
        baseline: dict[str, Any] = {"info": {"version": "1.0.0"}, "paths": {}}
        current: dict[str, Any] = {"info": {"version": "2.0.0"}, "paths": {}}
