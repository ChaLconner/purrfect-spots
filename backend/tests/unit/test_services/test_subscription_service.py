...
async def test_get_plan_prices_reads_current_stripe_amounts(mock_retrieve, subscription_service, monkeypatch):
    monkeypatch.setattr(SubscriptionService, "_plan_price_cache", None)
    with (
