...
class TestGalleryServiceSecurity:
    ...
    def gallery_service(self, mock_supabase_client, mock_supabase_admin_client):
        ...
        with patch("dependencies.get_supabase_client", return_value=mock_supabase_client), \
    ...
    def test_get_photo_by_id_uses_public_client(self, gallery_service, mock_supabase_client, mock_supabase_admin_client):
