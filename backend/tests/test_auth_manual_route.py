...
# Import routes
from routes.auth_manual import router, RegisterInput, LoginRequest
...
def mock_auth_service():
    """Mock AuthService"""
    with patch('routes.auth_manual.get_auth_service') as mock:
        service = MagicMock()
...
class TestRegisterEndpoint:
    ...
    def test_register_password_no_number(self, client, mock_limiter):
...
class TestRefreshTokenEndpoint:
    ...
    def test_refresh_token_success(self, client, mock_auth_service):
        ...
        mock_auth_service.verify_refresh_token.return_value = "test-user-id"
