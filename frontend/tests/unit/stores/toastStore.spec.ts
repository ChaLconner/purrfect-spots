...
import { useToastStore, addToast as legacyAddToast, removeToast as legacyRemoveToast, showError as legacyShowError, showSuccess as legacyShowSuccess, toastState } from '@/stores/toastStore';
