...
const config = [
  ...
  pluginSecurity.configs.recommended,
  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-explicit-any': 'error', // STRICT: No explicit any allowed
      '@typescript-eslint/explicit-function-return-type': 'warn', // STRICT: Warn on missing return types
      '@typescript-eslint/consistent-type-imports': 'error', // STRICT: Enforce type imports
      '@typescript-eslint/no-non-null-assertion': 'warn', // Discourage non-null assertion
      ...
      '@typescript-eslint/ban-ts-comment': 'warn', // Warn on ts-ignore
