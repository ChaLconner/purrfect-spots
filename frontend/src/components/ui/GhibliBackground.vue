<template>
  ...
  >
    ...
    <div class="gallery-bg-decorations absolute inset-0 w-full h-full">
      ...
      <!-- CSS Soot Sprites (Susuwatari) Removed as requested -->
...
.cloud-pattern-2::after {
  width: 45px;
  height: 45px;
  top: -25px;
  left: 15px;
}
.cloud-pattern-2::before {
  width: 35px;
  height: 35px;
  top: -15px;
  left: 45px;
...
.cloud-pattern-3::after {
  width: 55px;
  height: 55px;
  top: -30px;
  left: 30px;
}
.cloud-pattern-3::before {
  width: 45px;
  height: 45px;
  top: -20px;
  left: 75px;
...
.cloud-pattern-4::after {
  width: 35px;
  height: 35px;
  top: -20px;
  left: 10px;
}
.cloud-pattern-4::before {
  width: 25px;
  height: 25px;
  top: -12px;
  left: 45px;
