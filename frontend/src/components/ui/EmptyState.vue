<template>
  <div class="min-h-[400px] flex flex-col items-center justify-center p-8 text-center animate-fadeIn">
    ...
    <!-- Messages -->
    <div class="space-y-3 mb-12 relative z-10">
      <p class="text-[#5A4A3A] text-xl font-bold tracking-wide">
        {{ message }}
      </p>
      <p v-if="subMessage" class="text-[#5A4A3A]/70 font-medium tracking-wide max-w-lg mx-auto">
        {{ subMessage }}
      </p>
    </div>
