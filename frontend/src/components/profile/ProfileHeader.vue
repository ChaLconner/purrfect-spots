...
<template>
  ...
  >
    <!-- Decoration Circles -->
    <div
      class="absolute -top-10 -right-10 w-40 h-40 bg-orange-100 rounded-full opacity-50 blur-3xl"
    ></div>
    <div
      class="absolute -bottom-10 -left-10 w-40 h-40 bg-green-100 rounded-full opacity-50 blur-3xl"
    ></div>
