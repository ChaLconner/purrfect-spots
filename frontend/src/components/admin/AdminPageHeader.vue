<template>
  <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
    <div class="flex flex-col">
      <h1 class="text-2xl font-bold text-brown-900 font-heading tracking-tight">
        {{ title }}
      </h1>
    ...
    <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
      ...
      <div v-if="showSearch" class="relative w-full sm:max-w-md group">
        <span class="absolute inset-y-0 left-0 grid w-12 place-items-center text-brown-500 pointer-events-none" aria-hidden="true">
            <svg
              class="w-5 h-5"
