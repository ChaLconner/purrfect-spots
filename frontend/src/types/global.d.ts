...
declare global {
  ...
  type __VLS_FunctionalComponentProps<T, K> = '__ctx' extends keyof __VLS_PickNotAny<K, {}>
    ...
    : T extends (props: infer P, ...args: any) => any
      ? P
      : {};
  type __VLS_FunctionalComponent<T> = (
  ...
  type __VLS_ConstructorOverloads<T> =
    __VLS_OverloadUnion<T> extends infer F
  ...
  function __VLS_getVForSourceType<T extends number | string | any[] | Iterable<any>>(
    source: T
  ): [
  ...
  function __VLS_asFunctionalDirective<T>(
    dir: T
